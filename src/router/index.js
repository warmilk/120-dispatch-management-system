    ...
    routes: [{
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: "/admin/accountAdd",
                    component: resolve => require(["view/admin/accountAdd.vue"], resolve),
                    meta: {
                        requireAuth: true
                    }
                },
                ...
                // 管理员管理 -> 紧急通讯录
                {
                    ...
                    component: resolve =>
                        require(["view/admin/contactList.vue"], resolve),
                    meta: {
                        requireAuth: true
                    }
                },
                // 管理员管理 -> 紧急通讯录
                {
                    path: "/admin/contactAdd",
                    component: resolve =>
                        require(["@/view/admin/contactAdd.vue"], resolve),
                    meta: {
                        requireAuth: true
                    }
                },
                // 管理员管理 -> 紧急通讯录
                {
					...
					name: 'contactEdit',
                    component: resolve =>
                        require(["@/view/admin/contactEdit.vue"], resolve),
                    meta: {
                        requireAuth: true
                    }
                },
                // 管理员管理 -> 修改密码
                {
                    ...
                    component: resolve =>
                        require(["view/admin/password.vue"], resolve),
                    meta: {
                        requireAuth: true
                    }
                },
